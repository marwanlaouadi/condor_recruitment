...
class CountryStateCity extends Component
{
    ...
    public $selectedCountryId, $selectedStateId, $selectedCityId;
    ...
    public function render()
    {
        ...
        $selectedState = State::where('name', 'like', '%' . $this->selectedStateId . '%')->first();
    ...
    {
        $selectedCity = SearchCountry::where('name', 'like', '%' . $this->selectedCountryId . '%')->first();
