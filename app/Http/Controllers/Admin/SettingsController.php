...
class SettingsController extends Controller
{
    ...
    public function moveSslcEnvValueToConfig()
    {
        ...
        checkSetConfig('sslcommerz.store.id', $ssl_id);
        checkSetConfig('sslcommerz.store.password', $ssl_password);
        checkSetConfig('sslcommerz.active', $ssl_active ? true : false);
        checkSetConfig('sslcommerz.sandbox', $ssl_mode == 'sandbox' ? true : false);
    }
