@if (auth()->check())
    <li>
        <a href="{{ auth()->user()->role == 'company' ? route('company.messages'):route('candidate.messages') }}" class="tw-relative">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    stroke="#18191C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
