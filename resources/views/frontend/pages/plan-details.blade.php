...
@section('main')
    ...
    <section class="section benefits bgcolor--gray-10 mt-5 pt-5">
        <div class="container">
            @if (config('paypal.active') || config('zakirsoft.stripe_active'))
                <div class="row">
                    <h4>Demo Credentials For Online Payments</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="post-info d-flex">
                                    <div class="flex-grow-1">
                                        <b>Email</b>: any email address <br>
                                        <b>Card Number</b>: 4242 4242 4242 42424 <br>
                                        <b>Month/Year</b>: Any future date <br>
                    ...
                    <div class="col-4">
                        <div class="card jobcardStyle1">
                            <div class="card-body">
                                ...
                                <div class="post-info d-flex">
                                    <div class="flex-grow-1">
                                        <b>Email</b>: devboyarif@paypal.com <br>
